...
def compute_metrics(dataset_true, dataset_pred, 
    ...
    metrics = OrderedDict()
    metrics['sensitivity'] = classified_metric_pred.true_positive_rate()
    metrics['specificity'] = classified_metric_pred.true_negative_rate()
...
def validate_visualize2(dataset, y_pred_proba, attribute, metric='balanced_accuracy'):
    thresh_arr = np.linspace(0.01, 0.9, 50) # check with other

    privileged_group, unprivileged_group =  get_att_privilege_groups(attribute)

    df_og = pd.read_csv('results_tables/XGBoost_result_og_'+attribute+'.csv').iloc[:,1:]
    ...
    if metric=='balanced_accuracy':
        # abs(1-disparate impact)
        fig, ax1 = plt.subplots(figsize=(8,4))
        ax1.plot(thresh_arr, bal_acc_arr, linestyle='dashed')
        ax1.plot(thresh_arr, df_og['Balanced Accuracy'])
        ax1.set_xlabel('Classification Thresholds', fontsize=16, fontweight='bold')
        ax1.set_ylabel('Balanced Accuracy', color='b', fontsize=16, fontweight='bold')
        ax1.xaxis.set_tick_params(labelsize=14)
        ax1.yaxis.set_tick_params(labelsize=14)
        ...
        ax2 = ax1.twinx()
        ax2.plot(thresh_arr, np.abs(1.0-np.array(disp_imp_arr)), color='r', linestyle='dashed')
        ax2.plot(thresh_arr, np.abs(1.0-np.array(df_og['Disparate Impact'])), color='r')
        ax2.set_ylabel('abs(1-disparate impact)', color='r', fontsize=16)
        ax1.set_xlabel('Classification Thresholds', fontsize=16, fontweight='bold')
        ax1.set_ylabel('Balanced Accuracy', color='b', fontsize=16, fontweight='bold')
        ax1.xaxis.set_tick_params(labelsize=14)
        ...
        # average odds difference
        fig, ax3 = plt.subplots(figsize=(8,4))
        ax3.plot(thresh_arr, bal_acc_arr, linestyle='dashed')
        ax3.plot(thresh_arr, df_og['Balanced Accuracy'])
        ax3.set_xlabel('Classification Thresholds', fontsize=16, fontweight='bold')
        ax3.set_ylabel('Balanced Accuracy', color='b', fontsize=16, fontweight='bold')
        ax3.xaxis.set_tick_params(labelsize=14)
        ax3.yaxis.set_tick_params(labelsize=14)
        ...
        ax4 = ax3.twinx()
        ax4.plot(thresh_arr, avg_odds_diff_arr, color='g', linestyle='dashed')
        ax4.set_ylabel('avg odds difference', color='g', fontsize=16)
        ax4.plot(thresh_arr, df_og['Avg Odds Difference'])
        ax3.set_xlabel('Classification Thresholds', fontsize=16, fontweight='bold')
        ax3.set_ylabel('Balanced Accuracy', color='b', fontsize=16, fontweight='bold')
        ax3.xaxis.set_tick_params(labelsize=14)
        ax3.yaxis.set_tick_params(labelsize=14)
        ...
        # statistical parity difference
        fig, ax5 = plt.subplots(figsize=(8,4))
        ax5.plot(thresh_arr, bal_acc_arr, linestyle='dashed')
        ax5.plot(thresh_arr, df_og['Balanced Accuracy'])
        ax5.set_xlabel('Classification Thresholds', fontsize=16, fontweight='bold')
        ax5.set_ylabel('Balanced Accuracy', color='b', fontsize=16, fontweight='bold')
        ax5.xaxis.set_tick_params(labelsize=14)
        ax5.yaxis.set_tick_params(labelsize=14)
        ...
        ax6 = ax5.twinx()
        ax6.plot(thresh_arr, stat_par_diff, color='magenta', linestyle='dashed')
        ax6.set_ylabel('Statistical Parity Difference', color='magenta', fontsize=16)
        ax6.plot(thresh_arr, df_og['Statistical Parity Difference'])
        ax5.set_xlabel('Classification Thresholds', fontsize=16, fontweight='bold')
        ax5.set_ylabel('Balanced Accuracy', color='b', fontsize=16, fontweight='bold')
        ax5.xaxis.set_tick_params(labelsize=14)
        ax5.yaxis.set_tick_params(labelsize=14)
        ...
        # equal opportunity difference
        fig, ax7 = plt.subplots(figsize=(8,4))
        ax7.plot(thresh_arr, bal_acc_arr, linestyle='dashed')
        ax7.plot(thresh_arr, df_og['Balanced Accuracy'])
        ax7.set_xlabel('Classification Thresholds', fontsize=16, fontweight='bold')
        ax7.set_ylabel('Balanced Accuracy', color='b', fontsize=16, fontweight='bold')
        ax7.xaxis.set_tick_params(labelsize=14)
        ax7.yaxis.set_tick_params(labelsize=14)
        ...
        ax8 = ax7.twinx()
        ax8.plot(thresh_arr, eq_opp_diff, color='darkorange', linestyle='dashed')
        ax8.set_ylabel('Equal Opp Difference', color='darkorange', fontsize=16)
        ax8.plot(thresh_arr, df_og['Equal Opportunity Difference'])
        ax7.set_xlabel('Classification Thresholds', fontsize=16, fontweight='bold')
        ax7.set_ylabel('Balanced Accuracy', color='b', fontsize=16, fontweight='bold')
        ax7.xaxis.set_tick_params(labelsize=14)
        ax7.yaxis.set_tick_params(labelsize=14)
        ...
        # theil index
        fig, ax9 = plt.subplots(figsize=(8,4))
        ax9.plot(thresh_arr, bal_acc_arr, linestyle='dashed')
        ax9.plot(thresh_arr, df_og['Balanced Accuracy'])
        ax9.set_xlabel('Classification Thresholds', fontsize=16, fontweight='bold')
        ax9.set_ylabel('Balanced Accuracy', color='b', fontsize=16, fontweight='bold')
        ax9.xaxis.set_tick_params(labelsize=14)
        ax9.yaxis.set_tick_params(labelsize=14)
        ...
        ax10 = ax9.twinx()
        ax10.plot(thresh_arr, theil_ind, color='black', linestyle='dashed')
        ax10.set_ylabel('Theil Index', color='black', fontsize=16)
        ax10.plot(thresh_arr, df_og['Theil Index'])
        ax9.set_xlabel('Classification Thresholds', fontsize=16, fontweight='bold')
        ax9.set_ylabel('Balanced Accuracy', color='b', fontsize=16, fontweight='bold')
        ax9.xaxis.set_tick_params(labelsize=14)
        ax9.yaxis.set_tick_params(labelsize=14)
        ...
        # abs(1-disparate impact)
        fig, ax1 = plt.subplots(figsize=(8,4))
        ax1.plot(thresh_arr, TPR_arr, linestyle='dashed')
        ax1.plot(thresh_arr, df_og['sensitivity'])
        ax1.set_xlabel('Classification Thresholds', fontsize=16, fontweight='bold')
        ax1.set_ylabel('True Postive Rate', color='b', fontsize=16, fontweight='bold')
        ax1.xaxis.set_tick_params(labelsize=14)
        ax1.yaxis.set_tick_params(labelsize=14)
        ...
        # average odds difference
        fig, ax3 = plt.subplots(figsize=(8,4))
        ax3.plot(thresh_arr, TPR_arr, linestyle='dashed')
        ax3.plot(thresh_arr, df_og['sensitivity'])
        ax3.set_xlabel('Classification Thresholds', fontsize=16, fontweight='bold')
        ax3.set_ylabel('True Postive Rate', color='b', fontsize=16, fontweight='bold')
        ax3.xaxis.set_tick_params(labelsize=14)
        ax3.yaxis.set_tick_params(labelsize=14)
        ...
        # statistical parity difference
        fig, ax5 = plt.subplots(figsize=(8,4))
        ax5.plot(thresh_arr, TPR_arr, linestyle='dashed')
        ax5.plot(thresh_arr, df_og['sensitivity'])
        ax5.set_xlabel('Classification Thresholds', fontsize=16, fontweight='bold')
        ax5.set_ylabel('True Postive Rate', color='b', fontsize=16, fontweight='bold')
        ax5.xaxis.set_tick_params(labelsize=14)
        ...
        # equal opportunity difference
        fig, ax7 = plt.subplots(figsize=(8,4))
        ax7.plot(thresh_arr, TPR_arr, linestyle='dashed')
        ax7.plot(thresh_arr, df_og['sensitivity'])
        ax7.set_xlabel('Classification Thresholds', fontsize=16, fontweight='bold')
        ax7.set_ylabel('True Postive Rate', color='b', fontsize=16, fontweight='bold')
        ax7.xaxis.set_tick_params(labelsize=14)
        ax7.yaxis.set_tick_params(labelsize=14)
        ...
        # theil index
        fig, ax9 = plt.subplots(figsize=(8,4))
        ax9.plot(thresh_arr, TPR_arr, linestyle='dashed')
        ax9.plot(thresh_arr, df_og['sensitivity'])
        ax9.set_xlabel('Classification Thresholds', fontsize=16, fontweight='bold')
        ax9.set_ylabel('True Postive Rate', color='b', fontsize=16, fontweight='bold')
        ax9.xaxis.set_tick_params(labelsize=14)
        ax9.yaxis.set_tick_params(labelsize=14)
        ...
        # abs(1-disparate impact)
        fig, ax1 = plt.subplots(figsize=(8,4))
        ax1.plot(thresh_arr, TNR_arr, linestyle='dashed')
        ax1.plot(thresh_arr, df_og['specificity'])
        ax1.set_xlabel('Classification Thresholds', fontsize=16, fontweight='bold')
        ax1.set_ylabel('True Negative Rate', color='b', fontsize=16, fontweight='bold')
        ax1.xaxis.set_tick_params(labelsize=14)
        ax1.yaxis.set_tick_params(labelsize=14)
        ...
        # average odds difference
        fig, ax3 = plt.subplots(figsize=(8,4))
        ax3.plot(thresh_arr, TNR_arr, linestyle='dashed')
        ax3.plot(thresh_arr, df_og['specificity'])
        ax3.set_xlabel('Classification Thresholds', fontsize=16, fontweight='bold')
        ax3.set_ylabel('True Negative Rate', color='b', fontsize=16, fontweight='bold')
        ax3.xaxis.set_tick_params(labelsize=14)
        ax3.yaxis.set_tick_params(labelsize=14)
        ...
        # statistical parity difference
        fig, ax5 = plt.subplots(figsize=(8,4))
        ax5.plot(thresh_arr, TNR_arr, linestyle='dashed')
        ax5.plot(thresh_arr, df_og['specificity'])
        ax5.set_xlabel('Classification Thresholds', fontsize=16, fontweight='bold')
        ax5.set_ylabel('True Negative Rate', color='b', fontsize=16, fontweight='bold')
        ax5.xaxis.set_tick_params(labelsize=14)
        ax5.yaxis.set_tick_params(labelsize=14)
        ...
        # equal opportunity difference
        fig, ax7 = plt.subplots(figsize=(8,4))
        ax7.plot(thresh_arr, TNR_arr, linestyle='dashed')
        ax7.plot(thresh_arr, df_og['specificity'])
        ax7.set_xlabel('Classification Thresholds', fontsize=16, fontweight='bold')
        ax7.set_ylabel('True Negative Rate', color='b', fontsize=16, fontweight='bold')
        ax7.xaxis.set_tick_params(labelsize=14)
        ax7.yaxis.set_tick_params(labelsize=14)
        ...
        # theil index
        fig, ax9 = plt.subplots(figsize=(8,4))
        ax9.plot(thresh_arr, TNR_arr, linestyle='dashed')
        ax9.plot(thresh_arr, df_og['specificity'])
        ax9.set_xlabel('Classification Thresholds', fontsize=16, fontweight='bold')
        ax9.set_ylabel('True Negative Rate', color='b', fontsize=16, fontweight='bold')
        ax9.xaxis.set_tick_params(labelsize=14)
        ax9.yaxis.set_tick_params(labelsize=14)
